# model.py
from utils import prepare_features_from_raw  # magac sax ah
import pandas as pd
import numpy as np
import joblib
...
CSV_PATH = "clean_cars_dataset_1000.csv"   # car dataset cleaned file
df = pd.read_csv(CSV_PATH)

# 2) X, y  (Price is the target)
...
# 9) Optional: local custom input test
custom = {
    "Year": 2018,
    "Odometer_km": 40000,
    "Doors": 4,
